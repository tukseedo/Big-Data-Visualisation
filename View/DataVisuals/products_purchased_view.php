<h3 id="dataHeading" style="text-align: center;">Product's Purchase Date And Return Date</h3>
<h4 id="dataSubHeading" style="text-align: center;"><?php echo json_encode($locaArea) .": ". json_encode($selectedArea); ?></h4>
<div id="timeline" style="height: 90%; width: 100%;"></div>
